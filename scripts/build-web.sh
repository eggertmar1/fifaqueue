...
# Set dark background and safe area padding
sed -i.bak 's|height: 100%;|height: 100%; background-color: #121212; padding-bottom: env(safe-area-inset-bottom);|' dist/index.html
